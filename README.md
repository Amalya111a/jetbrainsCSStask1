...
Once you save this in your `README.md`, run these three commands to finish:

1. `git add README.md`
2. `git commit -m "docs: complete readme for task submission"`
3. `git push origin main`

**Would you like me to check if you have any other requirements left for Task #1
